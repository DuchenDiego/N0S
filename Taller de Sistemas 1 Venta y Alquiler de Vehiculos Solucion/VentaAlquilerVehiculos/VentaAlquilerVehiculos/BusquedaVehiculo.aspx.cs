...
{
    public partial class BusquedaVehiculo : System.Web.UI.Page
    {
        ...
        protected void btnbusqueda_Click(object sender, EventArgs e)
        {
            ...
            {
                GridView3.DataSource = servicio.obtenervehiculoshabilitados();
                GridView3.DataBind();
                GridView3.Visible = true;
            }
            else if (busqueda == string.Empty && DropDownList1.SelectedItem.Text == "Deshabilitados")
            {
                GridView3.DataSource = servicio.obtenervehiculosdeshabilitados();
                GridView3.DataBind();
                GridView3.Visible = true;
            }
            else if (DropDownList1.SelectedItem.Text == "Todos")
            {
                GridView3.DataSource = servicio.busquedavehiculos(busqueda, busqueda);
                GridView3.DataBind();
                GridView3.Visible = true;
            }
            else if (DropDownList1.SelectedItem.Text == "Habilitados")
            {
                GridView3.DataSource = servicio.busquedavehiculoshabilitados(busqueda, busqueda);
                GridView3.DataBind();
                GridView3.Visible = true;
            }
            else if (DropDownList1.SelectedItem.Text == "Deshabilitados")
            {
                GridView3.DataSource = servicio.busquedavehiculosdeshabilitados(busqueda, busqueda);
                GridView3.DataBind();
                GridView3.Visible = true;
            }
        }
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            String path = this.Server.MapPath(".") + "//PdfsGenerados//ReportesVehiculos.pdf";
            ...
            PdfPCell celdatitulo = new PdfPCell(new Phrase("Reporte de Busqueda de Vehiculos", fonttitulo));
            ...
            PdfPCell celdahead1 = new PdfPCell(new Phrase("Marca"));
            PdfPCell celdahead2 = new PdfPCell(new Phrase("Motor"));
            PdfPCell celdahead3 = new PdfPCell(new Phrase("Costo de Venta"));
            PdfPCell celdahead4 = new PdfPCell(new Phrase("Costo de Alquiler por Semana"));
            PdfPCell celdahead5 = new PdfPCell(new Phrase("Cantidad"));
            PdfPCell celdahead6 = new PdfPCell(new Phrase("Transmision"));
            PdfPCell celdahead7 = new PdfPCell(new Phrase("Motor"));
            PdfPCell celdahead8 = new PdfPCell(new Phrase("Disponibilidad"));
            PdfPCell celdahead9 = new PdfPCell(new Phrase("Grupo Nº"));
           // PdfPCell celdahead10 = new PdfPCell(new Phrase("Vista"));
            ...
            doc.Close();
            Process.Start(path);
           // System.Diagnostics.Process.Start("ReportesVehiculos.pdf");
        }
    }
}